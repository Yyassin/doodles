...
/**
 * Defines a sheet contnet component that displays the stable diffusion menu,
 * and allows the user to generate images from a textual prompt, conditioned on an
 * image generated by their current canvas selection, and place them on the canvas.
...
const StableDiffusionSheetContent = () => {
  ...
  /**
   * Generate an image from the current canvas selection, and extract
   * its data URL to be used as the conditioning image for stable diffusion.
   */
    ...
    <div className="p-[1.5rem]">
      ...
      <SheetFooter className="sm:justify-start pt-4">
        ...
        <Button
          disabled={isLoading}
          onClick={async () => {
            // TODO: Optimization, resize on set
            const imSize = 96;
